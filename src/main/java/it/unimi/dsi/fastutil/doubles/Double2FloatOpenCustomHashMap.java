...
public class Double2FloatOpenCustomHashMap extends AbstractDouble2FloatMap implements java.io.Serializable, Cloneable, Hash {
 ...
 public Float remove( final Object ok ) {
  ...
  int pos;
  // The starting point.
  if ( ( Double.doubleToLongBits(curr = key[ pos = ( it.unimi.dsi.fastutil.HashCommon.mix( strategy.hashCode(k) ) ) & mask ]) == 0 ) ) return (null);
 ...
 private final class MapEntrySet extends AbstractObjectSet<Double2FloatMap.Entry > implements FastEntrySet {
  ...
  public boolean contains( final Object o ) {
   ...
   if ( ( Double.doubleToLongBits(k) == 0 ) ) return ( Double2FloatOpenCustomHashMap.this.containsNullKey && ( (value[ n ]) == (((e.getValue()).floatValue())) ) );
   double curr;
   final double[] key = Double2FloatOpenCustomHashMap.this.key;
   int pos;
   // The starting point.
