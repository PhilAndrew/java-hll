...
public class Double2ObjectOpenHashMap <V> extends AbstractDouble2ObjectMap <V> implements java.io.Serializable, Cloneable, Hash {
 ...
 public V put( final Double ok, final V ov ) {
  final V v = (ov);
  final int pos = insert( ((ok).doubleValue()), v );
 ...
 public V remove( final Object ok ) {
  ...
  int pos;
  // The starting point.
  if ( ( Double.doubleToLongBits(curr = key[ pos = (int)it.unimi.dsi.fastutil.HashCommon.mix( Double.doubleToRawLongBits(k) ) & mask ]) == 0 ) ) return (this.defRetValue);
  if ( ( Double.doubleToLongBits(curr) == Double.doubleToLongBits(k) ) ) return (removeEntry( pos ));
  while( true ) {
   if ( ( Double.doubleToLongBits(curr = key[ pos = ( pos + 1 ) & mask ]) == 0 ) ) return (this.defRetValue);
   if ( ( Double.doubleToLongBits(curr) == Double.doubleToLongBits(k) ) ) return (removeEntry( pos ));
  }
 }
 public V get( final Double ok ) {
  final double k = ((ok).doubleValue());
  if ( ( Double.doubleToLongBits(k) == 0 ) ) return containsNullKey ? (value[ n ]) : (this.defRetValue);
  double curr;
  final double[] key = this.key;
  int pos;
  // The starting point.
 ...
 public boolean containsValue( final Object v ) {
  ...
  for( int i = n; i-- != 0; ) if ( ! ( Double.doubleToLongBits(key[ i ]) == 0 ) && ( (value[ i ]) == null ? (v) == null : (value[ i ]).equals(v) ) ) return true;
  return false;
 }
 ...
 final class MapEntry implements Double2ObjectMap.Entry <V>, Map.Entry<Double, V> {
  ...
  public boolean equals( final Object o ) {
   ...
   return ( Double.doubleToLongBits(key[ index ]) == Double.doubleToLongBits(((e.getKey()).doubleValue())) ) && ( (value[ index ]) == null ? ((e.getValue())) == null : (value[ index ]).equals((e.getValue())) );
  }
  public int hashCode() {
 ...
 private final class MapEntrySet extends AbstractObjectSet<Double2ObjectMap.Entry <V> > implements FastEntrySet <V> {
  ...
  public boolean contains( final Object o ) {
   ...
   if ( ( Double.doubleToLongBits(k) == 0 ) ) return ( Double2ObjectOpenHashMap.this.containsNullKey && ( (value[ n ]) == null ? ((e.getValue())) == null : (value[ n ]).equals((e.getValue())) ) );
   double curr;
   final double[] key = Double2ObjectOpenHashMap.this.key;
   int pos;
   // The starting point.
   if ( ( Double.doubleToLongBits(curr = key[ pos = (int)it.unimi.dsi.fastutil.HashCommon.mix( Double.doubleToRawLongBits(k) ) & mask ]) == 0 ) ) return false;
   if ( ( Double.doubleToLongBits(k) == Double.doubleToLongBits(curr) ) ) return ( (value[ pos ]) == null ? ((e.getValue())) == null : (value[ pos ]).equals((e.getValue())) );
   // There's always an unused entry.
   while( true ) {
    if ( ( Double.doubleToLongBits(curr = key[ pos = ( pos + 1 ) & mask ]) == 0 ) ) return false;
    if ( ( Double.doubleToLongBits(k) == Double.doubleToLongBits(curr) ) ) return ( (value[ pos ]) == null ? ((e.getValue())) == null : (value[ pos ]).equals((e.getValue())) );
