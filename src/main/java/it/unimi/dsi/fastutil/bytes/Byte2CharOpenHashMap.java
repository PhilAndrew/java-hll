...
public class Byte2CharOpenHashMap extends AbstractByte2CharMap implements java.io.Serializable, Cloneable, Hash {
 ...
 public Character remove( final Object ok ) {
  ...
  int pos;
  // The starting point.
  if ( ( (curr = key[ pos = ( it.unimi.dsi.fastutil.HashCommon.mix( (k) ) ) & mask ]) == ((byte)0) ) ) return (null);
 ...
 private final class MapEntrySet extends AbstractObjectSet<Byte2CharMap.Entry > implements FastEntrySet {
  ...
  public boolean contains( final Object o ) {
   ...
   if ( ( (k) == ((byte)0) ) ) return ( Byte2CharOpenHashMap.this.containsNullKey && ( (value[ n ]) == (((e.getValue()).charValue())) ) );
   byte curr;
   final byte[] key = Byte2CharOpenHashMap.this.key;
   int pos;
   // The starting point.
