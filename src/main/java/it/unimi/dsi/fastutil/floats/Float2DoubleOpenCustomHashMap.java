...
public class Float2DoubleOpenCustomHashMap extends AbstractFloat2DoubleMap implements java.io.Serializable, Cloneable, Hash {
 ...
 public Double remove( final Object ok ) {
  ...
  int pos;
  // The starting point.
  if ( ( Float.floatToIntBits(curr = key[ pos = ( it.unimi.dsi.fastutil.HashCommon.mix( strategy.hashCode(k) ) ) & mask ]) == 0 ) ) return (null);
  if ( ( Float.floatToIntBits(curr) == Float.floatToIntBits(k) ) ) return (Double.valueOf(removeEntry( pos )));
  while( true ) {
 ...
 public Double get( final Float ok ) {
  ...
  if ( ( Float.floatToIntBits(k) == 0 ) ) return containsNullKey ? (Double.valueOf(value[ n ])) : (null);
  float curr;
  final float[] key = this.key;
  int pos;
  // The starting point.
  if ( ( Float.floatToIntBits(curr = key[ pos = ( it.unimi.dsi.fastutil.HashCommon.mix( strategy.hashCode(k) ) ) & mask ]) == 0 ) ) return (null);
  if ( ( Float.floatToIntBits(k) == Float.floatToIntBits(curr) ) ) return (Double.valueOf(value[ pos ]));
 ...
 final class MapEntry implements Float2DoubleMap.Entry , Map.Entry<Float, Double> {
  ...
  public boolean equals( final Object o ) {
   ...
   return ( Float.floatToIntBits(key[ index ]) == Float.floatToIntBits(((e.getKey()).floatValue())) ) && ( (value[ index ]) == (((e.getValue()).doubleValue())) );
  }
  public int hashCode() {
 ...
 private final class MapEntrySet extends AbstractObjectSet<Float2DoubleMap.Entry > implements FastEntrySet {
  ...
  public boolean contains( final Object o ) {
   ...
   if ( ( Float.floatToIntBits(k) == 0 ) ) return ( Float2DoubleOpenCustomHashMap.this.containsNullKey && ( (value[ n ]) == (((e.getValue()).doubleValue())) ) );
   float curr;
   final float[] key = Float2DoubleOpenCustomHashMap.this.key;
   int pos;
   // The starting point.
   if ( ( Float.floatToIntBits(curr = key[ pos = ( it.unimi.dsi.fastutil.HashCommon.mix( strategy.hashCode(k) ) ) & mask ]) == 0 ) ) return false;
   if ( ( Float.floatToIntBits(k) == Float.floatToIntBits(curr) ) ) return ( (value[ pos ]) == (((e.getValue()).doubleValue())) );
   // There's always an unused entry.
   while( true ) {
    if ( ( Float.floatToIntBits(curr = key[ pos = ( pos + 1 ) & mask ]) == 0 ) ) return false;
    if ( ( Float.floatToIntBits(k) == Float.floatToIntBits(curr) ) ) return ( (value[ pos ]) == (((e.getValue()).doubleValue())) );
