...
public class Char2ObjectOpenCustomHashMap <V> extends AbstractChar2ObjectMap <V> implements java.io.Serializable, Cloneable, Hash {
 ...
 public V remove( final Object ok ) {
  ...
  int pos;
  // The starting point.
  if ( ( (curr = key[ pos = ( it.unimi.dsi.fastutil.HashCommon.mix( strategy.hashCode(k) ) ) & mask ]) == ((char)0) ) ) return (this.defRetValue);
 ...
 private final class MapEntrySet extends AbstractObjectSet<Char2ObjectMap.Entry <V> > implements FastEntrySet <V> {
  ...
  public boolean contains( final Object o ) {
   ...
   if ( ( (k) == ((char)0) ) ) return ( Char2ObjectOpenCustomHashMap.this.containsNullKey && ( (value[ n ]) == null ? ((e.getValue())) == null : (value[ n ]).equals((e.getValue())) ) );
   char curr;
   final char[] key = Char2ObjectOpenCustomHashMap.this.key;
   int pos;
   // The starting point.
