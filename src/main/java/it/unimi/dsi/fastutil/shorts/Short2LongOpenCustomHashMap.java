...
public class Short2LongOpenCustomHashMap extends AbstractShort2LongMap implements java.io.Serializable, Cloneable, Hash {
 ...
 public Long get( final Short ok ) {
  ...
  if ( ( (k) == ((short)0) ) ) return containsNullKey ? (Long.valueOf(value[ n ])) : (null);
  short curr;
  final short[] key = this.key;
  int pos;
  // The starting point.
 ...
 private final class MapEntrySet extends AbstractObjectSet<Short2LongMap.Entry > implements FastEntrySet {
  ...
  public boolean contains( final Object o ) {
   ...
   if ( ( (k) == ((short)0) ) ) return ( Short2LongOpenCustomHashMap.this.containsNullKey && ( (value[ n ]) == (((e.getValue()).longValue())) ) );
   short curr;
   final short[] key = Short2LongOpenCustomHashMap.this.key;
   int pos;
   // The starting point.
