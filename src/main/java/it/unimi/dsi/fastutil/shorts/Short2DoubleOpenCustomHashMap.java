...
public class Short2DoubleOpenCustomHashMap extends AbstractShort2DoubleMap implements java.io.Serializable, Cloneable, Hash {
 ...
 public Double get( final Short ok ) {
  ...
  if ( ( (k) == ((short)0) ) ) return containsNullKey ? (Double.valueOf(value[ n ])) : (null);
  short curr;
  final short[] key = this.key;
  int pos;
  // The starting point.
 ...
 private final class MapEntrySet extends AbstractObjectSet<Short2DoubleMap.Entry > implements FastEntrySet {
  ...
  public boolean contains( final Object o ) {
   ...
   if ( ( (k) == ((short)0) ) ) return ( Short2DoubleOpenCustomHashMap.this.containsNullKey && ( (value[ n ]) == (((e.getValue()).doubleValue())) ) );
   short curr;
   final short[] key = Short2DoubleOpenCustomHashMap.this.key;
   int pos;
   // The starting point.
