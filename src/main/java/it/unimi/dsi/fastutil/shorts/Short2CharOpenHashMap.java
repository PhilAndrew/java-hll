...
public class Short2CharOpenHashMap extends AbstractShort2CharMap implements java.io.Serializable, Cloneable, Hash {
 ...
 public Character remove( final Object ok ) {
  ...
  int pos;
  // The starting point.
  if ( ( (curr = key[ pos = ( it.unimi.dsi.fastutil.HashCommon.mix( (k) ) ) & mask ]) == ((short)0) ) ) return (null);
 ...
 private final class MapEntrySet extends AbstractObjectSet<Short2CharMap.Entry > implements FastEntrySet {
  ...
  public boolean contains( final Object o ) {
   ...
   if ( ( (k) == ((short)0) ) ) return ( Short2CharOpenHashMap.this.containsNullKey && ( (value[ n ]) == (((e.getValue()).charValue())) ) );
   short curr;
   final short[] key = Short2CharOpenHashMap.this.key;
   int pos;
   // The starting point.
