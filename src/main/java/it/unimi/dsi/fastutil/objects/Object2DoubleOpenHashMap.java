...
public class Object2DoubleOpenHashMap <K> extends AbstractObject2DoubleMap <K> implements java.io.Serializable, Cloneable, Hash {
 ...
 public Double remove( final Object ok ) {
  ...
  if ( ( (curr).equals(k) ) ) return (Double.valueOf(removeEntry( pos )));
  while( true ) {
 ...
 private class MapIterator {
  ...
  public void remove() {
   ...
   if ( last == n ) {
    ...
    Object2DoubleOpenHashMap.this.remove( wrapped.set( - pos - 1, null ) );
 ...
 private final class MapEntrySet extends AbstractObjectSet<Object2DoubleMap.Entry <K> > implements FastEntrySet <K> {
  ...
  public boolean contains( final Object o ) {
   ...
   final K k = (e.getKey());
   if ( ( (k) == null ) ) return ( Object2DoubleOpenHashMap.this.containsNullKey && ( (value[ n ]) == (((e.getValue()).doubleValue())) ) );
   K curr;
   final K[] key = Object2DoubleOpenHashMap.this.key;
   int pos;
   // The starting point.
   if ( ( (curr = key[ pos = ( it.unimi.dsi.fastutil.HashCommon.mix( (k).hashCode() ) ) & mask ]) == null ) ) return false;
   if ( ( (k).equals(curr) ) ) return ( (value[ pos ]) == (((e.getValue()).doubleValue())) );
   // There's always an unused entry.
   while( true ) {
    if ( ( (curr = key[ pos = ( pos + 1 ) & mask ]) == null ) ) return false;
    if ( ( (k).equals(curr) ) ) return ( (value[ pos ]) == (((e.getValue()).doubleValue())) );
