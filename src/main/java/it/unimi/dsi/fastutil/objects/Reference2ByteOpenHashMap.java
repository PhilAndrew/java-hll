...
public class Reference2ByteOpenHashMap <K> extends AbstractReference2ByteMap <K> implements java.io.Serializable, Cloneable, Hash {
 ...
 private class MapIterator {
  ...
  public void remove() {
   ...
   if ( last == n ) {
    ...
    Reference2ByteOpenHashMap.this.remove( wrapped.set( - pos - 1, null ) );
 ...
 private final class MapEntrySet extends AbstractObjectSet<Reference2ByteMap.Entry <K> > implements FastEntrySet <K> {
  ...
  public boolean contains( final Object o ) {
   ...
   final K k = (e.getKey());
   if ( ( (k) == (null) ) ) return ( Reference2ByteOpenHashMap.this.containsNullKey && ( (value[ n ]) == (((e.getValue()).byteValue())) ) );
   K curr;
   final K[] key = Reference2ByteOpenHashMap.this.key;
   int pos;
   // The starting point.
