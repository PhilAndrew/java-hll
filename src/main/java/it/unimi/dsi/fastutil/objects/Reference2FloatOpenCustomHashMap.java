...
public class Reference2FloatOpenCustomHashMap <K> extends AbstractReference2FloatMap <K> implements java.io.Serializable, Cloneable, Hash {
 ...
 private class MapIterator {
  ...
  public void remove() {
   ...
   if ( last == n ) {
    ...
    Reference2FloatOpenCustomHashMap.this.remove( wrapped.set( - pos - 1, null ) );
 ...
 private final class MapEntrySet extends AbstractObjectSet<Reference2FloatMap.Entry <K> > implements FastEntrySet <K> {
  ...
  public boolean contains( final Object o ) {
   ...
   final K k = (e.getKey());
   if ( ( (k) == (null) ) ) return ( Reference2FloatOpenCustomHashMap.this.containsNullKey && ( (value[ n ]) == (((e.getValue()).floatValue())) ) );
   K curr;
   final K[] key = Reference2FloatOpenCustomHashMap.this.key;
   int pos;
   // The starting point.
