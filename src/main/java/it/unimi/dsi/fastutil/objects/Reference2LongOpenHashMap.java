...
public class Reference2LongOpenHashMap <K> extends AbstractReference2LongMap <K> implements java.io.Serializable, Cloneable, Hash {
 ...
 private class MapIterator {
  ...
  public void remove() {
   ...
   if ( last == n ) {
    ...
    Reference2LongOpenHashMap.this.remove( wrapped.set( - pos - 1, null ) );
 ...
 private final class MapEntrySet extends AbstractObjectSet<Reference2LongMap.Entry <K> > implements FastEntrySet <K> {
  ...
  public boolean contains( final Object o ) {
   ...
   final K k = (e.getKey());
   if ( ( (k) == (null) ) ) return ( Reference2LongOpenHashMap.this.containsNullKey && ( (value[ n ]) == (((e.getValue()).longValue())) ) );
   K curr;
   final K[] key = Reference2LongOpenHashMap.this.key;
   int pos;
   // The starting point.
