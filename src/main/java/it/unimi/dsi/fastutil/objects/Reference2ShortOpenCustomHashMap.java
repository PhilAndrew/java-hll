...
public class Reference2ShortOpenCustomHashMap <K> extends AbstractReference2ShortMap <K> implements java.io.Serializable, Cloneable, Hash {
 ...
 private class MapIterator {
  ...
  public void remove() {
   ...
   if ( last == n ) {
    ...
    Reference2ShortOpenCustomHashMap.this.remove( wrapped.set( - pos - 1, null ) );
 ...
 private final class MapEntrySet extends AbstractObjectSet<Reference2ShortMap.Entry <K> > implements FastEntrySet <K> {
  ...
  public boolean contains( final Object o ) {
   ...
   final K k = (e.getKey());
   if ( ( (k) == (null) ) ) return ( Reference2ShortOpenCustomHashMap.this.containsNullKey && ( (value[ n ]) == (((e.getValue()).shortValue())) ) );
   K curr;
   final K[] key = Reference2ShortOpenCustomHashMap.this.key;
   int pos;
   // The starting point.
