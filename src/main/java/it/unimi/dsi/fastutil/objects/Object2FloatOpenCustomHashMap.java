...
public class Object2FloatOpenCustomHashMap <K> extends AbstractObject2FloatMap <K> implements java.io.Serializable, Cloneable, Hash {
 ...
 public Float remove( final Object ok ) {
  ...
  int pos;
  // The starting point.
  if ( ( (curr = key[ pos = ( it.unimi.dsi.fastutil.HashCommon.mix( strategy.hashCode(k) ) ) & mask ]) == null ) ) return (null);
  if ( ( strategy.equals( (curr), (k) ) ) ) return (Float.valueOf(removeEntry( pos )));
  while( true ) {
 ...
 final class MapEntry implements Object2FloatMap.Entry <K>, Map.Entry<K, Float> {
  ...
  public boolean equals( final Object o ) {
   ...
   return ( strategy.equals( (key[ index ]), ((e.getKey())) ) ) && ( (value[ index ]) == (((e.getValue()).floatValue())) );
  }
  public int hashCode() {
 ...
 private class MapIterator {
  ...
  private final void shiftKeys( int pos ) {
   ...
   for(;;) {
    ...
    if ( pos < last ) { // Wrapped entry.
     if ( wrapped == null ) wrapped = new ObjectArrayList <K>( 2 );
     wrapped.add( key[ pos ] );
    }
    key[ last ] = curr;
    value[ last ] = value[ pos ];
  ...
  public void remove() {
   ...
   if ( last == n ) {
    ...
    Object2FloatOpenCustomHashMap.this.remove( wrapped.set( - pos - 1, null ) );
 ...
 private final class MapEntrySet extends AbstractObjectSet<Object2FloatMap.Entry <K> > implements FastEntrySet <K> {
  ...
  public boolean contains( final Object o ) {
   ...
   final K k = (e.getKey());
   if ( ( (k) == null ) ) return ( Object2FloatOpenCustomHashMap.this.containsNullKey && ( (value[ n ]) == (((e.getValue()).floatValue())) ) );
   K curr;
   final K[] key = Object2FloatOpenCustomHashMap.this.key;
   int pos;
   // The starting point.
   if ( ( (curr = key[ pos = ( it.unimi.dsi.fastutil.HashCommon.mix( strategy.hashCode(k) ) ) & mask ]) == null ) ) return false;
   if ( ( strategy.equals( (k), (curr) ) ) ) return ( (value[ pos ]) == (((e.getValue()).floatValue())) );
   // There's always an unused entry.
   while( true ) {
    if ( ( (curr = key[ pos = ( pos + 1 ) & mask ]) == null ) ) return false;
    if ( ( strategy.equals( (k), (curr) ) ) ) return ( (value[ pos ]) == (((e.getValue()).floatValue())) );
