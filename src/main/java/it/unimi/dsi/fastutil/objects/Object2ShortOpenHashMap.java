...
public class Object2ShortOpenHashMap <K> extends AbstractObject2ShortMap <K> implements java.io.Serializable, Cloneable, Hash {
 ...
 public Short remove( final Object ok ) {
  ...
  if ( ( (curr).equals(k) ) ) return (Short.valueOf(removeEntry( pos )));
  while( true ) {
 ...
 private class MapIterator {
  ...
  public void remove() {
   ...
   if ( last == n ) {
    ...
    Object2ShortOpenHashMap.this.remove( wrapped.set( - pos - 1, null ) );
 ...
 private final class MapEntrySet extends AbstractObjectSet<Object2ShortMap.Entry <K> > implements FastEntrySet <K> {
  ...
  public boolean contains( final Object o ) {
   ...
   final K k = (e.getKey());
   if ( ( (k) == null ) ) return ( Object2ShortOpenHashMap.this.containsNullKey && ( (value[ n ]) == (((e.getValue()).shortValue())) ) );
   K curr;
   final K[] key = Object2ShortOpenHashMap.this.key;
   int pos;
   // The starting point.
   if ( ( (curr = key[ pos = ( it.unimi.dsi.fastutil.HashCommon.mix( (k).hashCode() ) ) & mask ]) == null ) ) return false;
   if ( ( (k).equals(curr) ) ) return ( (value[ pos ]) == (((e.getValue()).shortValue())) );
   // There's always an unused entry.
   while( true ) {
    if ( ( (curr = key[ pos = ( pos + 1 ) & mask ]) == null ) ) return false;
    if ( ( (k).equals(curr) ) ) return ( (value[ pos ]) == (((e.getValue()).shortValue())) );
