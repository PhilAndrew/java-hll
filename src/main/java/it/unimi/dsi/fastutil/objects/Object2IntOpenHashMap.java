...
public class Object2IntOpenHashMap <K> extends AbstractObject2IntMap <K> implements java.io.Serializable, Cloneable, Hash {
 ...
 public Integer remove( final Object ok ) {
  ...
  if ( ( (curr).equals(k) ) ) return (Integer.valueOf(removeEntry( pos )));
  while( true ) {
 ...
 private final class MapEntrySet extends AbstractObjectSet<Object2IntMap.Entry <K> > implements FastEntrySet <K> {
  ...
  public boolean contains( final Object o ) {
   ...
   final K k = (e.getKey());
   if ( ( (k) == null ) ) return ( Object2IntOpenHashMap.this.containsNullKey && ( (value[ n ]) == (((e.getValue()).intValue())) ) );
   K curr;
   final K[] key = Object2IntOpenHashMap.this.key;
   int pos;
   // The starting point.
   if ( ( (curr = key[ pos = ( it.unimi.dsi.fastutil.HashCommon.mix( (k).hashCode() ) ) & mask ]) == null ) ) return false;
   if ( ( (k).equals(curr) ) ) return ( (value[ pos ]) == (((e.getValue()).intValue())) );
   // There's always an unused entry.
   while( true ) {
    if ( ( (curr = key[ pos = ( pos + 1 ) & mask ]) == null ) ) return false;
    if ( ( (k).equals(curr) ) ) return ( (value[ pos ]) == (((e.getValue()).intValue())) );
